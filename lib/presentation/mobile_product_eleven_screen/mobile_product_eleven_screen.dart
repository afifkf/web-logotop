...
class MobileProductElevenScreen extends StatelessWidget {
  MobileProductElevenScreen({Key? key}) : super(key: key);
  ...
  Widget _buildPaymentMethodColumn(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text("Samurai", style: CustomTextStyles.titleMediumBold),
