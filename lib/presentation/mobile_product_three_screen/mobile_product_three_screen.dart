...
class MobileProductThreeScreen extends StatelessWidget {
  MobileProductThreeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the mobileProductOneScreen when the action is triggered.
  onTapBuyThisLogo(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mobileProductOneScreen);
  }
}
