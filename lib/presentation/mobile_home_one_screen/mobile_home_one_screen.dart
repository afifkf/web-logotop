...
class MobileHomeOneScreen extends StatelessWidget {
  MobileHomeOneScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildSquirrelColumn(BuildContext context) {
          ...
          children: [
            ...
            GestureDetector(
                ...
                child: Container(
                    width: 36.h,
                    margin:
                        EdgeInsets.only(left: 159.h, top: 8.v, bottom: 15.v),
                    padding:
