...
class MobileCategoryOneScreen extends StatelessWidget {
  MobileCategoryOneScreen({Key? key})
      : super(
          key: key,
        );
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 13.v),
                          _buildArrowRightFourteenSection(context),
                          SizedBox(height: 7.v),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath:
                                      ImageConstant.imgIconlyBoldArrowRight2,
                                  height: 13.v,
                                  width: 17.h,
                          ...
                          SizedBox(height: 5.v),
                          _buildArrowRightTwentySevenSection(context),
                          SizedBox(height: 6.v),
                          Padding(
                            padding: EdgeInsets.only(left: 47.h),
                            child: Row(
  ...
  /// Section Widget
  Widget _buildArrowRightFourteenSection(BuildContext context) {
    return Container(
  ...
  /// Section Widget
  Widget _buildArrowRightTwentySevenSection(BuildContext context) {
    return Align(
      alignment: Alignment.center,
      child: Padding(
        padding: EdgeInsets.only(
