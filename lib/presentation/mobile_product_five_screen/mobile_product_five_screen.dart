...
class MobileProductFiveScreen extends StatelessWidget {
  MobileProductFiveScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the mobileProductElevenScreen when the action is triggered.
  onTapBuyThisLogo(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mobileProductElevenScreen);
  }
}
